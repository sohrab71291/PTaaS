...
exports.influxImports = influxImports;
exports.influxEnvAndMetrics = influxEnvAndMetrics;
exports.influxHelperFunctions = influxHelperFunctions;
exports.influxSetup = influxSetup;
exports.influxTeardown = influxTeardown;
exports.influxIterationTracking = influxIterationTracking;
exports.influxRecordCall = influxRecordCall;
/** Imports – replace the basic http/check/sleep imports */
function influxImports() {
    return [
...
function influxEnvAndMetrics(testName, baseUrl = 'http://localhost:3000') {
    return [
...
function influxHelperFunctions() {
    return `
 ...
 */
function influxSetup(maxVusExpr = 0) {
    return `
 ...
 */
function influxIterationTracking(scenarioName) {
    return `
 ...
 */
function influxRecordCall(responseVar, scenarioExpr, apiTag, urlPath, sentBytesExpr, stepName) {
