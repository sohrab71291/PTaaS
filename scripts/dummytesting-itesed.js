...
export const options = {
  ...
  thresholds: {
    'http_req_duration{endpoint_type:app}': ['p(95)<3000'],
...
function replayStep(reqDef, jar, correlationVars) {
  ...
  check(res, {
    [reqDef.name + ' status is expected']: function (r) { return isResponseStatusExpected(r, effectiveExpectedStatus); },
    [reqDef.name + ' response time < 3000ms']: function (r) { return r.timings.duration < 3000; },
