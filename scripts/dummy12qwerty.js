...
const TEST_NAME = __ENV.TEST_NAME || 'Archer Permission and LookUp Session Replay';
...
const TEST_NAME_VALUE = TEST_NAME;
const SCENARIO_NAME = 'archer_permission_lookup_replay';
