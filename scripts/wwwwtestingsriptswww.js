...
const TEST_NAME = __ENV.TEST_NAME || 'Archer Classic Record Session Replay';
...
const SCENARIO_NAME = 'archer_classic_record_replay';
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_failed{endpoint_type:app}': ['rate<1.5'],
    'checks': ['rate>0.9'],
  },
};
...
function replayStep(reqDef, jar, correlationVars) {
  ...
  check(res, {
    ...
    [reqDef.name + ' response time < 1500ms']: function (r) { return r.timings.duration < 1500; },
