...
const TEST_NAME = __ENV.TEST_NAME || 'Archer Record Module Session Replay';
...
const TEST_NAME_INTERNAL = TEST_NAME;
const SCENARIO_NAME = 'archer_record_module_replay';
...
function replayStep(reqDef, jar, correlationVars) {
  ...
  check(res, {
    ...
    'Status:  404': function (r) { return r.status === 404; },
  });
